...
static PyObject * header_intersect_molecule(PyObject *self, PyObject *args)
{
    if(PySequence_Size(args) != 2)
        return NULL;
    PyObject *molecule1 = PySequence_GetItem(args, 0);
    PyObject *molecule2 = PySequence_GetItem(args, 1);
...
static PyMethodDef headerMethods[] = {
...
initheader(void)
{
    (void) Py_InitModule("header", headerMethods);
}
